...
var NodeInstanceEntityDependencyHelper = (function () {
    function NodeInstanceEntityDependencyHelper(messageBusService, iamService, nodeInstanceEntityTypeService) {
    ...
    return NodeInstanceEntityDependencyHelper;
}());
...
var NodeInstanceEntity = (function (_super) {
    ...
    function NodeInstanceEntity(nodeInstanceEntityDependencyHelper, entityDependencyHelper, context, schema) {
        var _this = _super.call(this, entityDependencyHelper, context, schema) || this;
        _this._nodeInstanceEntityDependencyHelper = undefined;
        _this._nodeInstanceEntityDependencyHelper = nodeInstanceEntityDependencyHelper;
        return _this;
    }
    Object.defineProperty(NodeInstanceEntity.prototype, "iamService", {
        get: function () {
    ...
    Object.defineProperty(NodeInstanceEntity.prototype, "messageBusService", {
        get: function () {
    ...
    Object.defineProperty(NodeInstanceEntity.prototype, "nodeInstanceEntityTypeService", {
        get: function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.messageBusService.publish('/processengine/node/' + this.id, msg)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 6:
                        _a.sent();
                        _a.label = 7;
                    case 7: return [4 /*yield*/, this.nodeInstanceEntityTypeService.createNextNode(context, this, boundary, token)];
                    case 8:
                        _a.sent();
                        _a.label = 9;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 23:
                        ...
                        _a.label = 24;
                    case 24: return [4 /*yield*/, this.nodeInstanceEntityTypeService.createNextNode(context, this, nextDef, currentToken)];
                    case 25:
                        _a.sent();
                        _a.label = 26;
                    case 26:
