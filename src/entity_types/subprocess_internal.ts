...
export class SubprocessInternalEntity extends NodeInstanceEntity implements ISubprocessInternalEntity {
  ...
  constructor(propertyBagFactory: IFactory<IPropertyBag>, invoker: IInvoker, entityType: IEntityType<ISubprocessInternalEntity>, context: ExecutionContext, schema: IInheritedSchema) {
